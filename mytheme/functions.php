...
function load_js(){
    ...
    wp_register_script('bootstrapjs', get_template_directory_uri() . '/js/boostrap.bundle.js', 'jquery', false, true);
...
function register_navwalker(){
	require_once dirname( __DIR__ ) . '/class-wp-bootstrap-navwalker.php';
}
